...
def caser(original_text, shift_amount, direction):
    output_text= ""
    if direction == "decode":
        shift_amount *= -1
    ...
    print(f"Here is the {direction}d code = {output_text}")
...
while should_continue:
    ...
    caser(original_text=text, shift_amount=shift, direction=direction)
